...
namespace VHBurguerOFC.Contexts;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CategoriaID).HasName("PK__Categori__F353C1C570AC2893");
        ...
        {
            entity.HasKey(e => e.Log_AlteracaoProdutoID).HasName("PK__Log_Alte__D06C51B7F6B1C1B8");
            ...
            entity.HasOne(d => d.Produto).WithMany(p => p.Log_AlteracaoProduto)
                ...
                .HasConstraintName("FK__Log_Alter__Produ__03F0984C");
        });

        modelBuilder.Entity<Produto>(entity =>
        {
            entity.HasKey(e => e.ProdutoID).HasName("PK__Produto__9C8800C3644516C3");
            ...
            entity.HasIndex(e => e.Nome, "UQ__Produto__7D8FE3B22F4FCDAA").IsUnique();
            ...
            entity.HasOne(d => d.Usuario).WithMany(p => p.Produto)
                ...
                .HasConstraintName("FK__Produto__Usuario__74AE54BC");
        ...
        {
            entity.HasKey(e => e.PromocaoID).HasName("PK__Promocao__254B583D8DB34758");
        ...
        {
            entity.HasKey(e => e.UsuarioID).HasName("PK__Usuario__2B3DE79881D48939");
